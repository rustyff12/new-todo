export const cardContainer =
  "border border-gray-300 rounded p-4 shadow-md space-y-3";

export const cardHeading = "text-2xl font-bold underline text-slate-800 mb-4";

export const inputBase = "w-full border border-gray-300 rounded px-3 py-2";
